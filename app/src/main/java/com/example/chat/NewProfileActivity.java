            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                mFriendDatabase.child(user_id).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        mprofileFriendCount.setText("Arkadaş Sayısı : "+len);
                        ...
                        mfriendReqReference.child(mFirebaseUser.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                if(dataSnapshot.hasChild(user_id)){
                                    ...
                                    //arkadaşlık isteği göndermiş kisi gönderen ise eğer profildeki buttonun textini İsteği geri çek yap
                                    if(request_type.equals("sent")){

                                        mCurrent_state="req_sent";
                                        mProfileSendReqButton.setText("İsteği geri çek");
                                        mProfileDeclineReqButton.setVisibility(View.INVISIBLE);
                                        mProfileDeclineReqButton.setEnabled(false);

                                    }
                                    //arkadaşlık isteği alınmışsa buttonun textini Arkadaşlık isteğini kabul et olarak değiştir ve görünür yap
                                    else if(request_type.equals("received")){
                                        mCurrent_state="req_received";
                                        mProfileSendReqButton.setText("Arkadaşlık isteğini kabul et");
        ...
        mProfileSendReqButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mUserId.equals(user_id)){
                    Toast.makeText(NewProfileActivity.this, "Kendine istek atamazsın", Toast.LENGTH_SHORT).show();
                    return ;
                }
                    ...
                    mRootReference.updateChildren(requestMap, new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                            if(databaseError==null){
                                ...
                                Toast.makeText(NewProfileActivity.this, "Arkadaşlık isteği gönderildi", Toast.LENGTH_SHORT).show();

                                mProfileSendReqButton.setEnabled(true);
                                mCurrent_state= "req_sent";
                                mProfileSendReqButton.setText("Arkadaşlık isteğini iptal et");

                            }
                            else{
                                mProfileSendReqButton.setEnabled(true);
                                Toast.makeText(NewProfileActivity.this, "Bir hata ile karşılaşıldı", Toast.LENGTH_SHORT).show();
                            }
                    ...
                    mRootReference.updateChildren(valueMap, new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                            if(databaseError == null){
                                ...
                                mProfileSendReqButton.setText("Arkadaşlık isteği gönder");
                                mProfileSendReqButton.setEnabled(true);
                                mProfileMessage.setVisibility(View.INVISIBLE);
                                mProfileMessage.setEnabled(false);
                                Toast.makeText(NewProfileActivity.this, "Arkadaşlık isteği reddedildi", Toast.LENGTH_SHORT).show();
                            }
                            else{

                                mProfileSendReqButton.setEnabled(true);
                                Toast.makeText(NewProfileActivity.this, "Arkadaşlık isteği reddedilemiyor", Toast.LENGTH_SHORT).show();
                    ...
                    mRootReference.updateChildren(valueMap, new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                            if(databaseError == null){
                                ...
                                mProfileMessage.setVisibility(View.INVISIBLE);
                                mProfileMessage.setEnabled(false);
                                Toast.makeText(NewProfileActivity.this, "Arkadaşlıktan çıkarıldı...", Toast.LENGTH_SHORT).show();
                            }
                            else{
                                mProfileSendReqButton.setEnabled(true);
                                Toast.makeText(NewProfileActivity.this, "Arkadaşlıktan çıkarılamıyor...", Toast.LENGTH_SHORT).show();
